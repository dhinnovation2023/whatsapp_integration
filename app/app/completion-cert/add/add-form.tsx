...
import { AddNewCompletionCertCustomerRequestData } from '@/app/api/completion-cert/customers/add-one/route';
...
const AddCompletionCertCustomerPageForm = ({ brands }: {
    brands: {
        name: string,
        id: string,
    }[]
    ...
    const [formData, setFormData] = useState<AddNewCompletionCertCustomerRequestData>({
        brand: '',
        customerName: '',
        customerType: '',
    ...
    async function handleFormSubmit(event: FormEvent) {
        ...
        try {
            ...
            const { data } = await axios.post<{ ok: boolean }>('/api/completion-cert/customers/add-one', requestData, {
                headers: {
...
export default AddCompletionCertCustomerPageForm