...
import { UpdateOneCompletionCertBrandRequestData } from '@/functions/completion-cert/brands/update-one';
...
const EditCompletionBrandPageForm = (data: {
    name: string,
    content: string,
    objectId: string,
}) => {
    ...
    async function handleFormSubmit(event: FormEvent) {
        ...
        try {
            ...
            const requestData: UpdateOneCompletionCertBrandRequestData = {
                ...formData,
                objectId: data.objectId,
            }

            await axios.post('/api/completion-cert/brands/update-one', requestData);
            router.push('/app/completion-cert/brand');
        ...
        router.push('/app/completion-cert/brands');
        setInProgress(false);
    }

    return (
        <DashboardLayout
            pageTitle='Edit Completion Brand'
        >
            <div
...
export default EditCompletionBrandPageForm