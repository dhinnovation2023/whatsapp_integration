...
import { AddOneCompletionCertBrandRequestData } from "@/functions/completion-cert/brands/add-one";
import DashboardLayout from "@/layouts/dashboard"
import { RiLoader4Line } from "@remixicon/react";
import axios from "axios";
import { ChangeEvent, FormEvent, useState } from "react"

const CompletionCertBrandAddPage = () => {
    ...
    async function handleFormSubmit (event: FormEvent) {
        ...
        setInProgress(true);
        try {
            const requestData: AddOneCompletionCertBrandRequestData = formData;
            await axios.post('/api/completion-cert/brands/add-one', requestData);
...
export default CompletionCertBrandAddPage