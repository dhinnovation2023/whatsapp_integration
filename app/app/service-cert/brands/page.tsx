                            ...
                            >
                                {
                                    [
                                        {
                                            label: "Edit",
                                            href: `/app/service-cert/brands/edit?id=${brand._id}`,
                                        },
                                        {
                                            label: "Delete",
                                            href: `/api/service/brands/delete-one?id=${brand._id}`,
                                        },
                                    ].map((item, index) => (
                                        <ActionsButtons
                                            {...item}
...
export default ServiceBrandsPage